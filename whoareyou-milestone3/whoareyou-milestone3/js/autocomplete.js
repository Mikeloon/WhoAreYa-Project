...
function autocomplete(inp, game) {
    ...
    inp.addEventListener("input", function (e) {
        ...
        for (i = 0; i < players.length; i++) {
            ...
            if (players[i].name.substring(0,val.length) == val) {
                ...
                b.innerHTML += `<div class='self-center'>
                                    <span class='font-bold'> <strong>${val}</strong></span><span class>${players[i].name.substring(val.length,players[i].name.length)}</span>
                ...
                b.addEventListener("click", function (e) {
                    ...
                    let jug = players.filter(jug => jug.name == inp.value)
                    addRow(jug[0].id);
                });
                a.appendChild(b);
            }
